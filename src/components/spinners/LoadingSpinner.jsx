...
export const LoadingSpinner1 = ({ size = 20 }) => {
    return (
        <div>
            <svg className="pl" viewBox="0 0 128 128" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
                <defs>
...
export const LoadingSpinnerLine = ({ size = 20 }) => {
    return (
